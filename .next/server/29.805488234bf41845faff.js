...
function Components(props) {
  ...
  const menu = __jsx(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, userinfo && __jsx(antd__WEBPACK_IMPORTED_MODULE_3__["Menu"], null, __jsx(antd__WEBPACK_IMPORTED_MODULE_3__["Menu"].Item, null, __jsx("a", {
    target: "_blank",
    href: `/www/user/${userinfo.id}`
  }, "\u6211\u7684\u4E3B\u9875")), __jsx(antd__WEBPACK_IMPORTED_MODULE_3__["Menu"].Item, {
    danger: true,
    onClick: () => {
      localStorage.clear();
  ...
  return __jsx("header", {
    ...
    style: {
      backgroundImage: `url(${profile.attributes.logo})`
    }
  })), __jsx("div", {
